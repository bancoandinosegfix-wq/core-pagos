...
interbancaria con la cámara compensadora.

## Módulos

| Módulo | Qué hace |
|---|---|
| `src/routes/transferencias.js` | Transferencias entre cuentas (CBU/CVU) y consulta de límite disponible |
| `src/services/limites.js` | Límites diarios por tipo de cliente (BA-OP-014) |
| `src/services/conciliacion.js` | **Intercambio de interfaces por SFTP** con la cámara compensadora (ventana 02:00–04:00) |
| `src/services/cuentas.js` | Saldos, débito y crédito |
| `src/services/auditoria.js` | Bitácora de operaciones (BCRA "A" 7724) |
